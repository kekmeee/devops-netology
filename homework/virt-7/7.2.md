...
IAM Policies NetologyTerraformPolicies:
...
access_key     ****************T26Z shared-credentials-file
secret_key     ****************HZix shared-credentials-file
...
1. В файле `main.tf` создайте ресурс [ec2 instance](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/instance).
...
2. Source:
- [main.tf](../../terraform/7.2/main.tf)
- [versions.tf](../../terraform/7.2/versions.tf)
- [outputs.tf](../../terraform/7.2/outputs.tf)
